package org.example.profitsoftgateway.filter;

import lombok.RequiredArgsConstructor;
import lombok.extern.slf4j.Slf4j;
import org.example.profitsoftgateway.auth.GoogleAuthenticationService;
...
public class AuthenticationFilter implements GlobalFilter, Ordered {
    ...
    public AuthenticationFilter(GoogleAuthenticationService googleAuthenticationService,
    ...
    private Mono<Void> authCallback(ServerWebExchange exchange) {
        ...
        return verifyState(state, exchange.getRequest())
                .then(googleAuthenticationService.processAuthenticationCallback(code, redirectUri)
                        ...
                        .then(sendRedirect(exchange, reactAddress)));
    }
